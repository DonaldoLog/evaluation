    ...
    public function run()
    {
        ...
        Group::where('id', 3)->first()->students()->attach($insertedIds);
         ...
         $users =[
            ...
            ['studentId' => '20192121237', 'name' => 'Osiel', 'last_name' => 'Hernández Rodríguez','password' => bcrypt('evaluacion2020'), 'admin' => 0],
        ...
        Group::where('id', 5)->first()->students()->attach($insertedIds);
         ...
         $users =[
            ...
            ['studentId' => '20182121062', 'name' => 'Brisa', 'last_name' => 'Camacho Alberto','password' => bcrypt('evaluacion2020'), 'admin' => 0],
            ...
            ['studentId' => '20182121132', 'name' => 'Juan Carlos', 'last_name' => 'Encarnación Falcón','password' => bcrypt('evaluacion2020'), 'admin' => 0],
        ...
        $users =[
            ...
            ['studentId' => '20162121022', 'name' => 'María Fernanda', 'last_name' => 'Castro Toral','password' => bcrypt('evaluacion2020'), 'admin' => 0],
