                                            ...
                                            <template v-if="tableData.length > 0">
                                                <template v-for="(teacher, index) in tableData">
                                                        <tr :key="index">
                                                            ...
                                                            <td> {{ teacher.email }} </td>
                                                            <td> <a class="btn btn-primary" target="_blank" :href="`${mainUrl}/stats/teacher/${teacher.id}/${evaluation.id}/0`"> Descargar </a> </td>
                                                        </tr>
                                                </template>
                                            </template>
                                            <template v-else>
...
import mainUrl from '../../mainUrl'
  ...
  export default {
    ...
    methods: {
        ...
        fetchData() {
            let dataFetchUrl = `${this.mainUrl}/stats/teachers-esc/data`;
